//solution for audio analytics
window.addEventListener('load', function() {

var audio = document.getElementById('audio');
var total_duration = Math.floor(audio.duration, 2);
console.log(total_duration);
var paragraph = document.getElementById('results_paragraph');
paragraph.innerHTML = "Ten podcast trwa " + total_duration + " sekund.";



})
/*https://developer.mozilla.org/pl/docs/Web/HTML/Element/audio*/
